...
class Dashboards : AppCompatActivity() {
    ...
    private fun prepareProductListData() {
        var beads = Products("Stussy Inpired",R.drawable.b1,"40PHP")
        productList.add(beads)
        beads = Products("Renek",R.drawable.b2,"40PHP")
        productList.add(beads)
        beads = Products("Pinkish",R.drawable.b3,"40PHP")
        productList.add(beads)
        beads = Products("Blackwhite",R.drawable.b4,"40PHP")
        productList.add(beads)
        beads = Products("Stussy Inspired Bracelet",R.drawable.b1,"40PHP")
        productList.add(beads)
        beads = Products("Renek",R.drawable.b2,"40PHP")
        productList.add(beads)
        beads = Products("Pinkish",R.drawable.b3,"40PHP")
