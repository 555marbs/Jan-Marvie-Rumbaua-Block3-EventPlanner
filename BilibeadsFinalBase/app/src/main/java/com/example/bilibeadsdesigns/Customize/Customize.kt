...
class Customize : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val layoutManager:RecyclerView.LayoutManager = GridLayoutManager(this, 2, LinearLayoutManager.HORIZONTAL,false)
        ...
        val itemList = listOf(
            ...
            ListItem(R.drawable.bead9),
            ListItem(R.drawable.bead10),
            ListItem(R.drawable.bead11),
            ListItem(R.drawable.bead12),
        )
